                ...
                {/* Relative Wrapper for Editor + Ruler Guides */}
                  ...
                  {plusButtonPos && (
                    <button
                      ...
                      className="z-[99] flex items-center justify-center w-7 h-7 bg-rose-500 hover:bg-rose-600 text-white rounded-full shadow-lg border border-white transition-transform duration-200 hover:scale-110 active:scale-95 cursor-pointer"
